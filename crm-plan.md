...
Client {
  *Name,
  *Organization , 
  *Phone - (Work -> Home , Mobile , Other) -> Dropdown 
    |
  add phone -> Multiple phone number Add

   *Emails - (Work -> Home , Mobile , Other) -> Dropdown 
    |
   add Email -> Multiple Emails number Add
   *All Owner -> Dropdown 
   Lables -> Employee , Solo Owner , Hot Lead , Werm Lead  , Cold Lead
   *Title
   *What VRS (Vecation Rental Service) They use?
